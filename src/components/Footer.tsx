...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-[var(--color-line)] bg-[var(--color-bg)] text-[var(--color-ink)]">
      <div
      ...
      <div className="relative z-10 mx-auto max-w-[1440px] px-4 pb-[calc(1.25rem+env(safe-area-inset-bottom,0px))] sm:px-6 sm:pb-0 lg:px-8">
        <nav
          className="flex flex-col divide-y divide-[var(--color-line)] border-b border-[var(--color-line)] sm:grid sm:grid-cols-3 sm:divide-x sm:divide-y-0"
          aria-label="Footer"
        >
        ...
        <div className="flex items-start justify-between gap-6 py-7 sm:items-center sm:py-6">
